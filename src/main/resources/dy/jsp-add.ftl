    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <#list table.cloumns as cloumn>
                <#if  cloumn.cloumnName!='id' &&  cloumn.cloumnName!='createdTime' &&  cloumn.cloumnName!='updatedTime'>
                    <#if cloumn.comment?contains('select')>
                        <div class="form-group">
                            <label for="${cloumn.cloumnName}"
                                   class="col-md-3 col-sm-3 col-xs-12 control-label">${cloumn.comment?split(";")[0]}</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="${cloumn.cloumnName}" id="${cloumn.cloumnName}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <#list cloumn.comment?split(";")[2]?split(",") as name>
                                        <label>
                                            <input type="radio" value="${name?split(":")[0]}"
                                                   id="${cloumn.cloumnName}${name_index}"
                                                   name="${cloumn.cloumnName}">${name?split(":")[1]}
                                        </label>
                                    </#list>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="checkbox">
                                    <#list cloumn.comment?split(";")[2]?split(",") as name>
                                        <label>
                                            <input type="checkbox" value="${name?split(":")[0]}"
                                                   id="${cloumn.cloumnName}${name_index}"
                                                   name="${cloumn.cloumnName}">${name?split(":")[1]}
                                        </label>
                                    </#list>
                    ...
                    <#elseif cloumn.javaType=='Date'>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                   for="creatdTime">${cloumn.comment}</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="${cloumn.cloumnName}" name="${cloumn.cloumnName}"
                    ...
                    <#elseif cloumn.cloumnType=='TEXT'>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                   for="${cloumn.cloumnName}">${cloumn.comment}</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea class="form-control" rows="5" id="${cloumn.cloumnName}"
                                          name="${cloumn.cloumnName}"></textarea>
                            </div>
                        </div>
                    <#else>
                        <div class="form-group">
...
<#list table.cloumns as cloumn>
    ...
    <#list table.cloumns as cloumn>
        ...
        <#elseif cloumn.comment?contains('radio')>
            var ${cloumn.cloumnName}=
            $("input[name='${cloumn.cloumnName}']:checked").val();
        <#else>
            var ${cloumn.cloumnName}=
            $("#${cloumn.cloumnName}").val();
        </#if>
    </#list>
        var params = {};
    <#list table.cloumns as cloumn>
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.status == 0) {
                    alert({
                        "title": "操作提示", "content": "操作成功", ok: function () {
