...
<mapper namespace="com.${package}.mapper.${table.className}Mapper">

    <select id="get${table.className}ById" resultType="com.${package}.bean.${table.className}">
        select
    ...
    <select id="get${table.className}ListByMap" resultType="com.${package}.bean.${table.className}"
    ...
    <insert id="insert${table.className}" parameterType="com.${package}.bean.${table.className}">
    ...
    <update id="update${table.className}" parameterType="com.${package}.bean.${table.className}">
