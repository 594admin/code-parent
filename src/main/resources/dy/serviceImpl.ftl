...
${lowerClassName}.setUpdatedTime(new Date());
    ...
    public Integer qdtxBatchDelete${table.className}(String ids)throws Exception{
        Map
<String,List
<String>> param=new HashMap
    <String
    ,List
    <String>>();
        String[] paramArrays=ids.split(",");
        List
        <String> idList=new ArrayList
            <String>();
                ...
                <String
                ,Object> param,Integer pageNo,Integer pageSize)throws Exception{
                ...
                List<${table.className}> ${lowerClassName}List = ${lowerClassName}Mapper.get${table.className}
                ListByMap(param);
