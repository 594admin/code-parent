...
import cn.bdqn.beans.${table.className};
import cn.bdqn.common.Constants;
import cn.bdqn.common.Page;
import cn.bdqn.common.ReturnResult;
import cn.bdqn.service.${lowerClassName}.${table.className}Service;
import cn.bdqn.util.EmptyUtils;
import cn.bdqn.util.ReturnResultUtil;
...
public class ${table.className}Controller {
    ...
    @ResponseBody
    public Page<${table.className}> search${table.className}(@RequestParam Map
<String,Object> param) {
