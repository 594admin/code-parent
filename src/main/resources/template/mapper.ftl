...
<mapper namespace="cn.${package}.dao.${lowerClassName}.${table.className}Mapper">
    ...
    <select id="get${table.className}ById" resultType="cn.${package}.beans.${table.className}">
        select
    ...
    <select id="get${table.className}ListByMap" resultType="cn.${package}.beans.${table.className}"
        ...
        <trim prefix="where" prefixOverrides="and | or">
            <#list table.cloumns as cloumn>
                <if test="${cloumn.fieldName} != null and ${cloumn.fieldName}!=-1">
    ...
    <insert id="insert${table.className}" parameterType="cn.${package}.beans.${table.className}">
    ...
    <update id="update${table.className}" parameterType="cn.${package}.beans.${table.className}">
